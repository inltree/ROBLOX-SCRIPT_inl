--[[
    ...
    (由Tora Is Me 制作)
    (源仓库：https://github.com/liebertsx/Tora-Library/tree/main)
]]
...
-- 获取：https://devforum.roblox.com/t/how-to-create-a-simple-rainbow-effect-using-tweenService/221849/2
local chromaColor
local rainbowTime = 5
task.spawn(function()
    while task.wait() do
